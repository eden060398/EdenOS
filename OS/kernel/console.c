...
// Parameters   :
//              c       -   A char to be printed (In)
//		row     -   An int that specifies the row the char shall be
//                          printed at (In)
//              column  -   An int that specifies the column the char shall be
//                          printed at (In)
//
// Return Value :   None
//
...
//
// Parameters   :
//              c       -   A pointer to a string terminated with a null
//                          character (In)
//              row     -   An int that specifies the row the string shall be
//                          printed at (In)
//		column	-   An int that specifies the column the string shall be
//                          printed at (In)
//
// Return Value :   None
//
...
// -----------
// 
// General      :   The function retrieves the current position of the cursor.
//
// Parameters   :   None
//
// Return Value :   The current position of the cursor (uint32_t)
//
// -----------------------------------------------------------------------------
...
// ------------
// 
// General      :   The function sets the color of the console.
//
// Parameters   :
//              fore    -   The color of the text (In)
//              back    -   The color of the background (In)
//
// Return Value :   None
//
// -----------------------------------------------------------------------------
