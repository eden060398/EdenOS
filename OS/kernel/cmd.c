...
//
// Process      :   Find the matching function for the command in the database
//                  and run it with the received parameters.
//
...
//
// Parameters   :
//              name    -   A pointer to a string that represents the commands
//                          name (In)
//              func    -   A pointer to the function that should be called once
